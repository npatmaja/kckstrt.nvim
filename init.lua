...
kckstrt! is a personalized nvim config based on kickstart.nvim
...
-- Remap for dealing with editing
...
end, { desc = '[S]earch [File] in file browser' })
...
vim.defer_fn(function()
  require('nvim-treesitter.configs').setup {
    ...
    ensure_installed = { 'c', 'cpp', 'go', 'lua', 'python', 'rust', 'tsx', 'javascript', 'typescript', 'vimdoc', 'vim', 'bash', 'markdown', 'templ', 'zig' },
...
local on_attach = function(_, bufnr)
  ...
  -- Disable rename from lsp, use inc_rename instead
...
cmp.setup {
  ...
  formatting = {
    ...
    format = require('kiroku').format_cmp,
